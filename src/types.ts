...
export type TeamTask = { id: number; title: string; taskTime: string | null; location: string | null; note: string | null; createdByName: string | null; createdAt: string; archivedAt: string | null; participants: TaskParticipant[] }
